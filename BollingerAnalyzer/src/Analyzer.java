...
public class Analyzer implements Runnable {
	...
	public ArrayList<Double[]> HighLowAverageResults;									// index 0 is upper bound percent distance from Bollinger Bands at pivots 
																						// index 1 is lower bound percent distance from Bollinger Bands at pivots
	public ArrayList<Double[]> HighPercentagesResults;									// Contain all arrays that contain 0 if no pivot, and a double value 
	public ArrayList<Double[]> LowPercentagesResults;									// with % distance to Bollinger Band if pivot occurs
	...
	private void plotScatterResults(ArrayList<Double[]> arrayListIn, String upperOrLowerBound) {
		...
		String title = "Distances from " + upperOrLowerBound + " Bollinger Band at Reversals";
	...
	private void plotCurveResults(ArrayList<Double[]> arrayListIn, String upperOrLowerBound) {
		...
		String title = "Frequency of Distances from " + upperOrLowerBound + " Bollinger Band at Reversals";
		String xAxisLabel = "Percentage of Closing Price Away From Bollinger Band";
